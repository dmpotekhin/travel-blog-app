...
- **Реализованы ADR-101…105**, **ADR-106** и **ADR-107** (все изменения прошли TDD, полный сьют — **392 passed**):
...
| **107** | **Tri-Face Carousel Factory**: универсальный движок каруселей для вертикалей Travel/QA/Vibecoding — источник URL или GitHub, 10 стадий от резолва до learnings, детерминированный Pillow-рендер 6×768×1376 JPG, human-in-the-loop approval, публикация через Upload-Post за абстракцией, аналитика без выдуманных чисел; API + вкладка «🎠 Carousels» + CLI `carousel`. |
